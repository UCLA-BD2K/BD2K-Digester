 ...
 */
public class HarvardCrawler extends ConcatCrawler {
    private final static String CRAWL_ID = "Harvard";
    private final static String ROOT_URL = "http://www.pic-sure.org/";
