 ...
 */
public class UCSCCrawler extends ConcatCrawler {
    private final static String CRAWL_ID = "UCSC";
    private final static String ROOT_URL = "https://genomics.soe.ucsc.edu/bd2k";
