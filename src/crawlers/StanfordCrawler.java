 ...
 */
public class StanfordCrawler extends ConcatCrawler {
    private final static String CRAWL_ID = "Stanford";
    private final static String ROOT_URL = "http://metadatacenter.org/";
