 ...
 */
public class ENIGMACrawler extends ConcatCrawler {
    private final static String CRAWL_ID = "ENIGMA";
    private final static String ROOT_URL = "http://enigma.ini.usc.edu/";
